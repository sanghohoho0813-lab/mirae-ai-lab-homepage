...
export const questions: DiagnosisQuestion[] = [
  ...
  },
  {
    ...
    stage: 3,
    type: 'single',
    title: '지원사업·인증 서류를 챙길 담당 직원이 있나요?',
    desc: '실제로 실행할 사람이 있는지가 준비 속도를 좌우해요.',
    showIf: (a) => !isFounderToBe(a),
    options: [
      { value: 'dedicated', label: '전담 직원이 있어요' },
      { value: 'partTime', label: '다른 일과 겸해서 챙겨요' },
      { value: 'ceo', label: '대표가 직접 챙겨요' },
      { value: 'none', label: '챙길 사람이 없어요' },
    ],
  },
  {
    id: 'newProduct',
