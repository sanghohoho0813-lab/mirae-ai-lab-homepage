...
export const AX_BUILD_STAGES: AxBuildStage[] = [
  {
    ...
    items: [
      ...
      '로그인과 데이터 저장은 포함하지 않는 초기 모델입니다.',
      '심사 설명자료와 같은 구조로 정리해 드립니다.',
    ],
  },
  {
    no: '2',
  ...
  },
  {
    ...
    items: [
      ...
      '역할별 권한을 세분화하고 알림을 붙입니다.',
      'STEP 2 제공사항을 모두 포함합니다.',
    ],
  },
]
...
export const AX_BUILD_STAGE_NOTE =
  '위 일정은 자료 접수와 의사결정이 원활한 경우의 목표 일정입니다. 외부 시스템 연동과 데이터 이전 범위, 추가 요청사항에 따라 달라질 수 있으며 금액은 모두 VAT 별도입니다.'
