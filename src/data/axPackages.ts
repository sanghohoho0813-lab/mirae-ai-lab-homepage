...
export const AX_PACKAGES: AxPackage[] = [
  {
    ...
    price: '100만원',
    priceNote: 'VAT 별도',
    oneLiner: '우리 회사 업무 중 무엇을 AX로 바꿀지 먼저 정해요.',
    included: [
      '대표자·기업 인터뷰',
      '현재 사업과 자금문제 진단',
      'AX로 바꿀 핵심업무 선정',
  ...
  },
  {
    ...
    price: '500만원',
    priceNote: 'VAT 별도',
    oneLiner: 'B에 특허출원 연계와 12개월 자금 계획까지 더해요.',
    included: [
      'B 프로그램 전체',
      '특허 아이디어 발굴과 기술구조 설계',
...
export const AX_BUILD_STAGES: AxBuildStage[] = [
  {
    ...
    toneText: 'text-white',
    items: [
      '핵심 화면 8~12개를 눌러 볼 수 있게 만들어요.',
      '대표·직원·고객 화면이 이어지게 해요.',
      '로그인·데이터 저장이 없는 초기 모델이에요.',
      '심사 자료와 같은 순서로 정리해 드려요.',
    ],
  },
  {
    no: '2',
    ...
    items: [
      ...
      '핵심 업무 한 가지가 실제로 돌아가요.',
      '관리자 화면과 현장용 모바일 화면을 같이 드려요.',
      '실사용 테스트와 초기 개선까지 해 드려요.',
    ],
  },
  {
    no: '3',
