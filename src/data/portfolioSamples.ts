...
export const AX_PLATFORM_SAMPLES: AxPlatformSample[] = [
  {
    ...
    name: 'MATERIX',
    industry: '산업·건축자재 유통',
    line: '견적부터 재고까지 한 화면에, AI가 자재도 추천해요',
  ...
  },
  {
    ...
    name: 'LUMIÈRE',
    industry: '헤어숍',
    line: '예약부터 재방문까지 챙기고, AI가 스타일을 추천해요',
  ...
  },
  {
    ...
    name: '세움정밀솔루션',
    industry: '제조 · 정밀가공',
    line: '견적부터 납기·원가까지 잇고, AI가 리포트로 정리해요',
  ...
  },
  {
    ...
    name: 'VELOA BEAUTY',
    industry: '뷰티 커머스',
    line: '채널별 재고와 발주를 모으고, AI가 분석해 줘요',
  ...
  },
  {
    ...
    name: '에듀마스터',
    industry: '학원·교육',
    line: '출결과 상담을 챙기고, AI가 이탈 위험을 알려 줘요',
  ...
  },
  {
    ...
    name: 'VITALON',
    industry: '웰니스·피트니스',
    line: '회원 예약·재등록을 챙기고, AI가 웰니스 계획을 짜요',
  ...
  },
  {
    ...
    name: '오토브릿지 케어',
    industry: '자동차 정비',
    line: '정비 예약과 이력을 모으고, AI가 점검을 추천해요',
  ...
  },
  {
    ...
    name: 'LIVARTÉ',
    industry: '인테리어·리모델링',
    line: '상담부터 원가까지 관리하고, AI로 스타일을 찾아요',
  ...
  },
  {
    ...
    name: 'CLEANWAY',
    industry: '현장 서비스업',
    line: '현장 일정부터 재계약까지 한곳에 모은 AI 운영센터',
  ...
  },
  {
    ...
    name: '고운솥 식당',
    industry: '음식점 · F&B',
    line: '수요를 예측해 발주를 돕고, AI가 매출을 브리핑해요',
  ...
  },
  {
    ...
    name: 'NEXMART',
    industry: '유통·커머스',
    line: '재고와 배송, 발주를 챙기고, AI가 재구매를 추천해요',
  ...
  },
  {
    ...
    name: 'MORFIT',
    industry: '패션·의류',
    line: '재입고와 반품을 관리하고, AI가 스타일을 추천해요',
...
export const PORTFOLIO_SECTION = {
  ...
  note: '미래AI랩이 직접 기획하고 만든 MVP 10종이에요. 고객사 실적이 아닌 자체 데모이며, 카드를 누르면 새 창으로 열립니다.',
} as const
