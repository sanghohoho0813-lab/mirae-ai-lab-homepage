...
export const AX_PLATFORM_SAMPLES: AxPlatformSample[] = [
  {
    ...
    name: 'MATERIX',
    industry: '산업·건축자재 유통',
    line: '견적·주문이 재고와 이어지고, 자재 추천은 AI가 해요',
  ...
  },
  {
    ...
    name: 'LUMIÈRE',
    industry: '헤어숍',
    line: '재방문할 손님을 챙기고, 스타일은 AI가 추천해요',
  ...
  },
  {
    ...
    name: '세움정밀솔루션',
    industry: '제조 · 정밀가공',
    line: '견적부터 납기·원가까지 보고, 리포트는 AI가 써요',
  ...
  },
  {
    ...
    name: 'VELOA BEAUTY',
    industry: '뷰티 커머스',
    line: '채널마다 흩어진 재고·발주를 한곳에, AI 분석까지',
  ...
  },
  {
    ...
    name: '에듀마스터',
    industry: '학원·교육',
    line: '그만둘 것 같은 학생을 AI가 먼저 짚어 줘요',
  ...
  },
  {
    ...
    name: 'VITALON',
    industry: '웰니스·피트니스',
    line: '재등록할 회원을 챙기고, 관리 계획은 AI가 짜요',
  ...
  },
  {
    ...
    name: '오토브릿지 케어',
    industry: '자동차 정비',
    line: '차마다 정비 이력이 남고, 다음 점검은 AI가 추천해요',
  ...
  },
  {
    ...
    name: 'LIVARTÉ',
    industry: '인테리어·리모델링',
    line: '고객은 AI로 스타일을 찾고, 회사는 공정·원가를 챙겨요',
  ...
  },
  {
    ...
    name: 'CLEANWAY',
    industry: '현장 서비스업',
    line: '현장 일정부터 재계약까지, AI 운영센터에서 한눈에',
  ...
  },
  {
    ...
    name: '고운솥 식당',
    industry: '음식점 · F&B',
    line: '얼마나 팔릴지 보고 발주하고, 매출은 AI가 브리핑해요',
  ...
  },
  {
    ...
    name: 'NEXMART',
    industry: '유통·커머스',
    line: '재고·배송을 챙기고, 다시 살 상품은 AI가 추천해요',
  ...
  },
  {
    ...
    name: 'MORFIT',
    industry: '패션·의류',
    line: '재입고·반품을 챙기고, 고객 코디는 AI가 추천해요',
