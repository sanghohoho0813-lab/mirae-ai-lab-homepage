...
export const businessPackages: BusinessPackage[] = [
  {
    ...
    faqs: [
      ...
      { q: '비용이 정말 59만원이 전부인가요?', a: '네. 업계에서 흔한 성공수수료(실행액의 5~7%)를 받지 않습니다. 진단·전략 비용 59만원이 전부입니다.' },
  ...
  },
  {
    ...
    short: '반복업무 자동화 프로그램 · 상담 후 최종 견적',
    price: '299만원부터',
    priceNote: '기업 규모와 자동화 범위에 따라 상담 후 최종 견적이 안내됩니다.',
    priceType: 'consult',
    highlights: ['반복업무 자동화 프로그램 구축', '업무 진단 후 자동화 범위 설계', '기업 규모·범위에 따라 상담 후 견적'],
    ...
    notice:
      '표시 금액(299만원부터)은 시작 기준 금액이며, 최종 견적은 기업 규모와 자동화 범위에 따라 상담 후 확정됩니다.',
    featured: true,
  },
  {
    id: 'ax-full-package',
