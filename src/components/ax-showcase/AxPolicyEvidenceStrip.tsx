...
// 그 영역 안에 놓일 때는(detailLink=false) 자기 자신을 가리키게 되므로 링크를 숨긴다.
import { Link } from 'react-router-dom'
import { AX_EVIDENCE_DISCLAIMER, AX_POLICY_EVIDENCE_2026 } from '../../data/policyAxEvidence2026'

export default function AxPolicyEvidenceStrip({ tone = 'dark', detailLink = true }: { tone?: 'dark' | 'light'; detailLink?: boolean }) {
