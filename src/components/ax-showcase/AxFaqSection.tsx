...
export const AX_FAQ = [
  ...
  },
  {
    ...
    a: '고객이 전화나 카톡 대신 직접 주문하고 다시 사는 화면이에요. B2B는 거래처가 견적·발주·재주문·납기 확인을 하는 포털, B2C는 고객이 예약·주문·재구매를 하는 플랫폼이에요. 거창한 플랫폼도, 단순한 홈페이지도 아니고요. 고객이 쉽게 고르고, 다시 사고, 하나 더 사게(업셀) 돕는 게 목표예요.',
  },
  {
  ...
  {
    q: '우리처럼 작은 회사도 필요한가요?',
    a: '무조건 필요하다고는 말씀 안 드려요. 그래도 회사 밖에 보여 줄 일이 있다면 규모와 상관없이 꼭 필요하다고 봐요. 다음 단계로 가려는 회사라면 특히 추천드려요.',
  },
  {
    q: '처음부터 큰돈을 들여 전부 만들어야 하나요?',
    a: '아니요. 효과가 가장 큰 핵심 업무부터 시작해요. 범위는 AX만인지, 플랫폼·포털까지인지, MVP인지와 회사 상황에 따라 달라요. 개발 단계별로 선정산하는 방식도 있고, 현금이 빠듯하면 착수금 일부만 컨설팅 비용으로 받고 개발비는 자금 조달 뒤 정산하는 방식도 있어요. 자세한 건 상담에서 안내해 드려요.',
  },
  {
  ...
  },
  {
    ...
    a: '네, 같이 준비할 수 있어요. 9년 차 기업성장 컨설턴트가 현장에서 시작한 회사라, 세무사·변리사·법무사·노무사 등과 협업해 법인전환, 법인정비, 고용지원금, 사내근로복지기금, 특허, 절세까지 함께 봐요.',
  },
  {
