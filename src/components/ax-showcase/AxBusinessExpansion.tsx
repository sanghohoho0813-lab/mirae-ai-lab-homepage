...
export default function AxBusinessExpansion({ industryName }: { industryName: string }) {
  return (
    <div className="rounded-3xl border border-amber-400/25 bg-gradient-to-br from-amber-400/[0.09] to-transparent p-4 sm:p-6">
      <p className="break-keep text-[1.25rem] font-black leading-tight text-white sm:text-[1.6rem]">여기서 끝나지 않습니다.</p>
      <p className="mt-2.5 max-w-3xl break-keep text-[0.95rem] leading-relaxed text-slate-300 sm:text-[1.05rem]">
