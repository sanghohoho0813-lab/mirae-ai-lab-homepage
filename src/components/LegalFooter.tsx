  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl px-6 py-10">
        ...
        <div className={`mt-5 flex flex-col gap-1 text-[0.902rem] sm:text-[0.95rem] ${dark ? 'text-slate-500' : 'text-slate-400'} sm:flex-row sm:items-center sm:justify-between`}>
