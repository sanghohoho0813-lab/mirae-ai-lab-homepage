...
export default function KakaoFloat() {
  ...
  return (
    <a
      ...
      className={`fixed right-4 bottom-[calc(env(safe-area-inset-bottom,0px)+84px)] z-40 inline-flex items-center gap-2 rounded-full bg-[#FEE500] px-4 py-3 text-[0.92rem] font-black text-[#181600] shadow-lg shadow-slate-900/20 ring-1 ring-black/5 transition-all duration-200 hover:-translate-y-0.5 sm:right-6 sm:bottom-6 ${
