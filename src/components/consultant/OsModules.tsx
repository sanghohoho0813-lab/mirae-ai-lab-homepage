...
export const OS_MODULES: OsModule[] = [
  ...
  {
    name: '기업성장 모듈',
    desc: '인증, 자금, 인력 지원처럼 회사가 클 때 필요한 일을 요건 확인부터 사후관리까지 챙겨요.',
  ...
  {
    name: '정부지원사업 모듈',
    desc: '고객사에 맞는 공고를 찾아 주고, 신청부터 발표까지 마감을 놓치지 않게 챙겨요.',
  ...
  {
    name: 'IP·R&D 모듈',
    desc: '기술 아이디어를 특허 출원 준비와 연구개발 계획으로 정리하고, 사업화까지 이어 가요.',
  ...
  {
    name: 'AX 구축 모듈',
    desc: '고객사 업무를 진단하고, MVP·화면·자동화 설계까지 AX의 첫 단계를 정해진 틀로 진행해요.',
  ...
  {
    name: 'WEB STUDIO',
    desc: '고객사 홈페이지와 랜딩페이지를 기획, 문구, 디자인, 배포까지 한 번에 만들어요.',
