...
function Example({ children }: { children: ReactNode }) {
  return (
    <div className="mt-3 flex items-start gap-2.5 rounded-2xl border border-teal-100 bg-teal-50/70 px-4 py-3">
      <span className="mt-0.5 shrink-0 rounded-md bg-teal-500 px-2 py-0.5 text-[1.1rem] sm:text-[1.0rem] font-black text-white">예를 들어</span>
      <p className="text-[1.17rem] sm:text-[1.06rem] leading-relaxed text-slate-700">{children}</p>
    </div>
  )
}
  ...
  return (
    <span className={`relative inline-flex items-center ${className}`}>
      ...
      {open && (
        <span
          role="tooltip"
          className="absolute left-1/2 top-full z-20 mt-1.5 w-64 -translate-x-1/2 rounded-xl bg-slate-900 px-3 py-2.5 text-[1.1rem] sm:text-[1.0rem] font-medium leading-relaxed text-slate-100 shadow-xl"
        >
          {children}
        </span>
      )}
  ...
  return (
    <div className="mx-auto mt-8 flex w-full max-w-md flex-col gap-2.5 sm:flex-row sm:justify-center">
      <Link
        ...
        className="flex min-h-[52px] flex-1 items-center justify-center rounded-xl bg-teal-400 px-6 text-[1.29rem] sm:text-[1.17rem] font-black text-slate-900 shadow-lg shadow-teal-500/20 transition-transform hover:-translate-y-0.5"
      >
        3분 기업진단
      </Link>
      <button
        type="button"
        onClick={onConsult}
        className={`flex min-h-[52px] flex-1 items-center justify-center rounded-xl border px-6 text-[1.26rem] sm:text-[1.15rem] font-bold transition-colors ${
...
function Guarantee({ dark = false }: { dark?: boolean }) {
  return (
    <p className={`mx-auto mt-6 max-w-md text-center text-[1.1rem] sm:text-[1.0rem] leading-relaxed ${dark ? 'text-slate-500' : 'text-slate-400'}`}>
  ...
  return (
    <div ref={rootRef} className="min-h-screen bg-white pb-24 text-slate-900 antialiased [word-break:keep-all] sm:pb-0">
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-2.5">
          ...
          <Link to="/" className="flex min-w-0 items-center gap-2.5">
            ...
            <span className="flex min-w-0 flex-col leading-tight">
              ...
              <span className="hidden break-keep text-[1.0rem] font-medium text-slate-500 sm:block">Mirae AI Lab · <b className="font-bold text-slate-800">미래경영지원센터</b></span>
            </span>
          </Link>
          <div className="flex shrink-0 items-center gap-2.5 sm:gap-4">
            <Link to="/business-services" className="hidden text-[1.2rem] sm:text-[1.09rem] font-medium text-slate-600 transition-colors hover:text-slate-900 sm:inline">서비스몰 홈</Link>
            <Link to="/business-diagnosis" className="whitespace-nowrap rounded-lg bg-slate-900 px-3 py-2 text-[1.2rem] sm:px-4 sm:text-[1.09rem] font-semibold text-white shadow-sm transition-colors hover:bg-slate-700">
              3분 기업진단
            </Link>
            <HeaderAccount />
          </div>
      ...
      <div className="border-b border-slate-100 bg-slate-50/60">
        <div className="mx-auto max-w-6xl px-5 py-2.5 text-[1.1rem] sm:text-[1.0rem] text-slate-500 sm:px-6 sm:text-sm">
      ...
      <section className="relative overflow-hidden bg-slate-900">
        ...
        <div className="relative mx-auto max-w-3xl px-5 py-12 text-center sm:px-6 sm:py-20">
          <span className="inline-flex items-center gap-2 rounded-full border border-amber-300/30 bg-amber-400/10 px-3.5 py-1.5 text-[1.1rem] sm:text-[1.0rem] font-bold text-amber-200 backdrop-blur">
            정책자금 × <Tip term="AX" className="text-amber-200">AI 전환(AI Transformation). 사람이 반복하던 업무를 자동화·디지털화해 회사 운영 방식을 바꾸는 것.</Tip> 혁신전환
          </span>
          <h1 className="mt-5 text-[1.87rem] font-black leading-[1.28] tracking-tight text-white sm:text-[2.4rem] sm:leading-[1.18]">
            정책자금, 계속 거절당하거나<br /><span className="text-amber-300">몇천만원</span>에서 멈추셨나요?
          </h1>
          <p className="mx-auto mt-5 max-w-xl text-[1.29rem] sm:text-[1.17rem] leading-relaxed text-slate-300 sm:text-lg">
            이제는 디지털 전환을 넘어 AI 전환, <b className="font-bold text-amber-300">AX의 시대</b>입니다.
          </p>
          <p className="mx-auto mt-4 max-w-xl text-[1.33rem] sm:text-[1.21rem] font-bold leading-relaxed text-white sm:text-lg">
            <span className="text-amber-300">1억원 이상</span> 정책자금을 목표로, 자금을 받을 이유가 보이는 AX 혁신기업 구조를 만듭니다.
          </p>
          <p className="mx-auto mt-3.5 max-w-xl text-[1.24rem] sm:text-[1.13rem] leading-relaxed text-slate-300">
          ...
          <div className="mx-auto mt-6 max-w-xl rounded-2xl border border-amber-400/25 bg-amber-400/[0.07] px-5 py-4">
            <p className="text-[1.24rem] sm:text-[1.13rem] font-bold leading-relaxed text-white">
              인터뷰와 동시에 설계를 시작해, <span className="text-amber-300">최대 2주</span> 안에 최종 결과물 완성을 목표로 합니다.
            </p>
            <p className="mt-2 text-[1.1rem] sm:text-[1.0rem] leading-relaxed text-slate-400">
          ...
          <div className="mx-auto mt-7 flex w-full max-w-md flex-col gap-2.5 sm:flex-row sm:justify-center">
            <Link
              to="/business-diagnosis"
              className="flex min-h-[52px] flex-1 items-center justify-center rounded-xl bg-teal-400 px-7 text-[1.33rem] sm:text-[1.21rem] font-black text-slate-900 shadow-lg shadow-teal-500/20 transition-transform hover:-translate-y-0.5"
            >
              3분 기업진단
            </Link>
            <button
              ...
              className="flex min-h-[52px] flex-1 items-center justify-center rounded-xl border border-white/25 bg-white/5 px-7 text-[1.29rem] sm:text-[1.17rem] font-bold text-white transition-colors hover:bg-white/10"
            >
              2주 진행과정 보기
            </button>
          </div>
          <p className="mt-5 text-[1.1rem] sm:text-[1.0rem] font-semibold leading-relaxed text-teal-200">
      ...
      <section className={`bg-white ${band}`}>
        <div className={inner}>
          ...
          <p className="mx-auto mt-3 max-w-xl text-center text-[1.33rem] sm:text-[1.21rem] font-black leading-relaxed text-slate-900">
            문제는 그렇지 않은 기업입니다.
          </p>
          <ul className="mx-auto mt-6 max-w-xl divide-y divide-slate-200 rounded-2xl border border-slate-200 bg-slate-50">
            {REALITY.map((r) => (
              <li key={r} className="flex items-start gap-2.5 px-4 py-2.5">
                ...
                <span className="text-[1.21rem] sm:text-[1.1rem] leading-relaxed text-slate-700">{r}</span>
              </li>
            ))}
          </ul>
          <div className="mx-auto mt-6 max-w-xl rounded-3xl border-2 border-slate-900 bg-slate-900 p-5 text-center sm:p-6">
            <p className="text-[1.33rem] sm:text-[1.21rem] font-black leading-snug text-white">사업이 부족해서가 아닐 수 있습니다.</p>
            <p className="mt-2.5 text-[1.24rem] sm:text-[1.13rem] leading-relaxed text-slate-300">
              심사자가 더 큰 자금을 지원해야 할 이유를 충분히 확인하지 못했을 수 있습니다.
            </p>
            <p className="mt-3 text-[1.26rem] sm:text-[1.15rem] font-bold text-teal-300">그렇다고 방법이 없는 것은 아닙니다.</p>
          </div>
        </div>
      </section>
          ...
          <ul className="mx-auto mt-7 max-w-xl space-y-2.5">
            {PLAN_LINES.map((l) => (
              <li key={l} className="flex items-start gap-2.5 rounded-2xl border border-slate-200 bg-white px-4 py-3.5 shadow-sm">
                ...
                <span className="text-[1.26rem] sm:text-[1.15rem] font-bold leading-relaxed text-slate-800">{l}</span>
              </li>
            ))}
          </ul>
          <Example>
      ...
      <section id="policy-2026" className={`scroll-mt-16 bg-slate-50 ${band}`}>
        <div className={inner}>
          <h2 className="text-[1.49rem] font-black leading-snug tracking-tight text-slate-900 sm:text-[1.85rem]">
            2026 정책변화와 AX 공식근거
          </h2>
          <p className="mt-3 max-w-2xl text-[1.33rem] sm:text-[1.21rem] leading-relaxed text-slate-600">
        ...
        <div className={inner}>
          ...
          <div className="mt-7 grid grid-cols-2 gap-2.5 sm:gap-4">
            <div className="rounded-2xl border border-slate-200 bg-white p-2.5 sm:p-4">
              <p className="mb-2 inline-flex rounded-md bg-slate-200 px-2 py-0.5 text-[1.1rem] font-black text-slate-600 sm:mb-3 sm:px-2.5 sm:py-1 sm:text-[1.0rem]">Before</p>
              ...
              <p className="mt-2.5 text-[1.2rem] font-bold leading-snug text-slate-700 sm:text-[1.15rem]">문서로만 설명</p>
              <p className="mt-1 text-[1.11rem] leading-relaxed text-slate-500 sm:text-[1.06rem]">심사자가 실제 모습을 상상해야 합니다.</p>
            </div>
            <div className="rounded-2xl border-2 border-teal-300 bg-teal-50/40 p-2.5 shadow-sm sm:p-4">
              <p className="mb-2 inline-flex rounded-md bg-teal-500 px-2 py-0.5 text-[1.1rem] font-black text-white sm:mb-3 sm:px-2.5 sm:py-1 sm:text-[1.0rem]">After</p>
              <Shot src="/ax-industries/facility-building/04.webp" alt="정기점검·관리성과·재계약까지 이어지는 AX 화면 예시" />
              <p className="mt-2.5 text-[1.2rem] font-bold leading-snug text-slate-900 sm:text-[1.15rem]">화면과 데이터로 확인</p>
              <p className="mt-1 text-[1.11rem] leading-relaxed text-slate-600 sm:text-[1.06rem]">눈으로 보이니 설명이 훨씬 쉬워집니다.</p>
            </div>
          </div>

          <div className="mt-6 rounded-3xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
            <span className="inline-flex rounded-md bg-slate-900 px-2.5 py-1 text-[1.1rem] sm:text-[1.0rem] font-black text-teal-300">{CASE_A.label}</span>
            <div className="mt-4 grid gap-5 sm:grid-cols-2">
              <div>
                <p className="text-[1.24rem] sm:text-[1.13rem] font-black text-slate-900">기존 문제</p>
                <ul className="mt-2 space-y-1.5">
                  {CASE_A.problems.map((p) => (
                    <li key={p} className="flex items-start gap-2 text-[1.18rem] sm:text-[1.07rem] leading-relaxed text-slate-500">
              ...
              <div>
                <p className="text-[1.24rem] sm:text-[1.13rem] font-black text-slate-900">AX 전환 내용</p>
                <ul className="mt-2 space-y-1.5">
                  {CASE_A.changes.map((c) => (
                    <li key={c} className="flex items-start gap-2 text-[1.18rem] sm:text-[1.07rem] leading-relaxed text-slate-700">
                      <span className="mt-0.5 shrink-0 font-black text-teal-500" aria-hidden>✓</span>
                      <span>{c}</span>
                    </li>
                  ))}
            ...
            <div className="mt-5 grid gap-2.5 sm:grid-cols-2">
              <div className="rounded-2xl bg-slate-100 px-4 py-3.5">
                <p className="text-[1.1rem] sm:text-[1.0rem] font-black tracking-tight text-slate-500">자금 설명 · Before</p>
                <p className="mt-1 text-[1.24rem] sm:text-[1.13rem] leading-relaxed text-slate-600">{CASE_A.before}</p>
              </div>
              <div className="rounded-2xl bg-slate-900 px-4 py-3.5">
                <p className="text-[1.1rem] sm:text-[1.0rem] font-black tracking-tight text-teal-300">자금 설명 · After</p>
                <p className="mt-1 text-[1.24rem] sm:text-[1.13rem] font-bold leading-relaxed text-white">{CASE_A.after}</p>
              </div>
            </div>
            <p className="mt-4 text-[1.13rem] sm:text-[1.03rem] font-bold text-teal-700">현재 상태 · {CASE_A.status}</p>
            <p className="mt-1.5 text-[1.1rem] sm:text-[1.0rem] leading-relaxed text-slate-500">{CASE_A.notice}</p>
          </div>
        </div>
      </section>
          ...
          <ol className="mx-auto mt-7 max-w-xl space-y-2">
            {DELIVERABLES.map((d, i) => (
              <li key={d.t} className="flex items-start gap-3 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3.5">
                <span className="mt-0.5 grid h-7 w-7 shrink-0 place-items-center rounded-full bg-slate-900 text-[1.1rem] sm:text-[1.0rem] font-black text-amber-300">{i + 1}</span>
                <span className="min-w-0">
                  <span className="block text-[1.26rem] sm:text-[1.15rem] font-black leading-snug text-slate-900">{d.t}</span>
                  <span className="mt-0.5 block text-[1.18rem] sm:text-[1.07rem] leading-relaxed text-slate-600">{d.d}</span>
                </span>
              </li>
            ))}
          </ol>
          ...
          <div className="mt-6 grid grid-cols-2 gap-2.5 sm:gap-4">
            {DELIVERABLE_SHOTS.map((s) => (
              <figure key={s.img}>
                ...
                <figcaption className="mt-2 text-center text-[1.1rem] leading-snug text-slate-500 sm:text-[1.0rem]">{s.cap}</figcaption>
              </figure>
            ))}
          </div>
      ...
      <section id="ax-packages" className={`scroll-mt-16 bg-slate-950 ${band}`}>
        <div className={inner}>
          <p className="text-center text-[1.1rem] sm:text-[1.0rem] font-black tracking-tight text-teal-300">프로그램 · 비용</p>
          <h2 className="mt-2.5 text-center text-[1.65rem] font-black leading-[1.3] tracking-tight text-white sm:text-[2rem]">
            어디까지 준비할지<br /><span className="text-teal-300">먼저 고르세요.</span>
          </h2>
          <p className="mx-auto mt-4 max-w-xl text-center text-[1.26rem] leading-relaxed text-slate-300 sm:text-[1.21rem]">
      ...
      <section className={`bg-slate-50 ${band}`}>
        <div className={inner}>
          <h2 className="text-center text-[1.65rem] font-black leading-snug tracking-tight text-slate-900 sm:text-[2rem]">
            시연형 MVP 다음,<br className="sm:hidden" /> 운영형 개발은 어디까지 만드나요?
          </h2>
          <p className="mx-auto mt-4 max-w-xl text-center text-[1.26rem] sm:text-[1.15rem] leading-relaxed text-slate-600">
          ...
          <div className="mt-8 rounded-3xl border-2 border-amber-300 bg-amber-50/70 p-5 sm:p-7">
            <p className="text-[1.43rem] font-black leading-snug text-slate-900 sm:text-[1.55rem]">
              {AX_BUILD_PAYMENT.title}
            </p>
            <div className="mt-4 space-y-2.5">
              {AX_BUILD_PAYMENT.lines.map((t) => (
                <p key={t} className="break-keep text-[1.23rem] sm:text-[1.12rem] leading-relaxed text-slate-800">{t}</p>
              ))}
            </div>
            <div className="mt-5 rounded-2xl bg-white p-4 ring-1 ring-inset ring-amber-200">
              <p className="text-[1.17rem] sm:text-[1.06rem] font-black text-amber-700">일반 개발회사와 비교하면</p>
              <div className="mt-3 grid gap-2.5 sm:grid-cols-2">
                <div className="rounded-xl bg-slate-50 p-3.5">
                  <p className="text-[1.12rem] sm:text-[1.02rem] font-black text-slate-500">일반 개발회사</p>
                  <p className="mt-1.5 break-keep text-[1.19rem] sm:text-[1.08rem] leading-snug text-slate-600">
                    착수금·중도금으로 수천만원을 먼저 지급
                  </p>
                </div>
                <div className="rounded-xl bg-teal-50 p-3.5 ring-1 ring-inset ring-teal-200">
                  <p className="text-[1.12rem] sm:text-[1.02rem] font-black text-teal-700">미래AI랩</p>
                  <p className="mt-1.5 break-keep text-[1.19rem] sm:text-[1.08rem] font-bold leading-snug text-teal-900">
            ...
            <ul className="mt-4 space-y-1">
              {AX_BUILD_PAYMENT.notes.map((t) => (
                <li key={t} className="break-keep text-[1.1rem] sm:text-[1.0rem] leading-relaxed text-slate-500">· {t}</li>
              ))}
            </ul>
          </div>
      ...
      <section id="compare" className={`scroll-mt-16 bg-white ${band}`}>
        <div className="mx-auto max-w-5xl">
            ...
            {COMPARE.map((col) =>
              col.highlight ? (
                <div key={col.label} className="relative rounded-3xl border-2 border-blue-500 bg-white p-6 shadow-sm">
                  <span className="absolute -top-3 left-6 inline-flex rounded-full bg-blue-600 px-3 py-1 text-[1.1rem] sm:text-[1.0rem] font-black text-white shadow-sm">여기가 다릅니다</span>
                  <p className="mt-1 text-[1.2rem] sm:text-[1.09rem] font-black text-blue-600">{col.label}</p>
                  <ul className="mt-4 space-y-2.5">
                    {col.items.map((t) => (
                      <li key={t} className="flex items-start gap-2 text-[1.2rem] sm:text-[1.09rem] font-semibold leading-relaxed text-slate-700">
                ...
                <div key={col.label} className="rounded-3xl border border-slate-200 bg-slate-50 p-6">
                  <p className="text-[1.2rem] sm:text-[1.09rem] font-black text-slate-400">{col.label}</p>
                  <ul className="mt-4 space-y-2.5">
                    {col.items.map((t) => (
                      <li key={t} className="flex items-start gap-2 text-[1.2rem] sm:text-[1.09rem] leading-relaxed text-slate-500">
                        <span className="mt-0.5 shrink-0" aria-hidden>—</span>
                        <span>{t}</span>
                      </li>
                    ))}
          ...
          <p className="mx-auto mt-6 max-w-2xl rounded-3xl border border-slate-200 bg-slate-50 p-5 text-center text-[1.26rem] sm:text-[1.15rem] font-bold leading-relaxed text-slate-800">
      ...
      <section className={`bg-slate-50 ${band}`}>
        <div className={inner}>
          ...
          <div className="mx-auto mt-5 flex max-w-2xl flex-col items-center rounded-3xl border border-slate-200 bg-white p-6 text-center shadow-sm sm:p-8">
            ...
            <p className="mt-3 text-[1.1rem] sm:text-[1.0rem] font-bold text-teal-600">김팀장 · 정책자금·AX 성장설계 총괄</p>
            <h2 className="mt-2 text-[1.52rem] font-black leading-snug tracking-tight text-slate-900 sm:text-[1.4rem]">
              대표 컨설턴트가 직접 듣고,<br />직접 설계하고, 끝까지 확인합니다.
            </h2>
            <p className="mt-3 text-[1.26rem] sm:text-[1.15rem] leading-relaxed text-slate-600">
            ...
            <div className="mt-4 rounded-2xl border border-amber-300 bg-amber-50/70 px-5 py-4">
              <p className="text-[1.29rem] sm:text-[1.17rem] font-black leading-snug text-slate-900">한 달에 5개 기업만 진행합니다.</p>
              <p className="mt-2 text-[1.18rem] sm:text-[1.07rem] leading-relaxed text-slate-600">
                모든 프로젝트에 직접 참여하기 때문에, 동시에 진행할 수 있는 기업 수가 정해져 있습니다. 자리를 재촉하는 마케팅이 아니라 품질을 유지하기 위한 기준입니다.
              </p>
            </div>
            <p className="mt-4 rounded-2xl bg-slate-50 px-4 py-3 text-[1.17rem] sm:text-[1.06rem] leading-relaxed text-slate-600">
              세무·노무·법무·자금 분야 합산 9년 현장 경험. 정책자금·정부지원금·법인컨설팅 전문, ISO 9001·14001·45001 심사원. 누적 자금조달 지원 100억원+ (지원금·세금 환급 포함).
            </p>
            <p className="mt-3 text-[1.1rem] sm:text-[1.0rem] leading-relaxed text-slate-500">
          ...
          <div className="mt-8 space-y-2.5">
            {[
              ...
              <details key={f.q} className="group rounded-2xl border border-slate-200 bg-white p-5 [&_summary]:cursor-pointer">
                <summary className="flex items-center justify-between text-[1.29rem] sm:text-[1.17rem] font-bold text-slate-900 marker:content-['']">
                  <span>Q. {f.q}</span>
                  <span className="ml-3 shrink-0 text-slate-400 transition-transform group-open:rotate-45" aria-hidden>+</span>
                </summary>
                <div className="mt-3 text-[1.24rem] sm:text-[1.13rem] leading-relaxed text-slate-600">{f.a}</div>
              </details>
            ))}
          </div>
        </div>
      ...
      <section className={`bg-white ${band}`}>
        <div ref={finalCtaRef} className="mx-auto max-w-[640px] rounded-3xl bg-slate-900 p-7 text-center shadow-xl sm:p-10">
          <p className="text-[1.1rem] sm:text-[1.0rem] font-black tracking-tight text-amber-300">먼저 확인하세요</p>
          <h2 className="mt-3 text-[1.59rem] font-black leading-[1.34] tracking-tight text-white sm:text-[1.85rem]">
            이번에도 몇천만원에서 끝날지,<br /><span className="text-amber-300">1억원 이상을 설명할 구조</span>가 있는지<br />먼저 확인해보세요.
          </h2>
          <p className="mx-auto mt-4 max-w-md text-[1.26rem] sm:text-[1.15rem] leading-relaxed text-slate-300">
            3분 기업진단으로 현재 상황을 정리하고, <b className="text-white">{FLAGSHIP.name}</b> 상담으로 이어갈 수 있습니다.
          </p>
          <CtaButtons dark onConsult={openConsult} />
          <p className="mt-5 text-[1.1rem] sm:text-[1.0rem] leading-relaxed text-slate-400">진단만으로 별도 비용이 발생하지 않습니다.</p>
          <p className="mt-1 text-[1.1rem] sm:text-[1.0rem] leading-relaxed text-slate-500">선별 진행 여부는 진단과 상담 후 안내합니다.</p>
          <Guarantee dark />
        </div>
      </section>
      ...
      {showBar && !atEnd && (
        <div className="fixed inset-x-0 bottom-0 z-40 flex items-center gap-3 border-t border-slate-200 bg-white/95 px-4 pb-[max(0.5rem,env(safe-area-inset-bottom))] pt-2 shadow-[0_-4px_16px_rgba(15,23,42,0.06)] backdrop-blur-md sm:hidden">
          <span className="min-w-0 flex-1">
            <span className="block truncate text-[1.2rem] sm:text-[1.09rem] font-black text-slate-900">{FLAGSHIP.name}</span>
            <span className="block truncate text-[1.1rem] sm:text-[1.0rem] font-medium text-slate-500">3분 기업진단으로 시작하세요</span>
          </span>
          <Link to="/business-diagnosis" className="flex min-h-[44px] shrink-0 items-center justify-center gap-2 rounded-xl bg-slate-900 px-6 text-[1.2rem] sm:text-[1.09rem] font-bold text-white">
            3분 기업진단
          </Link>
        </div>
      )}
