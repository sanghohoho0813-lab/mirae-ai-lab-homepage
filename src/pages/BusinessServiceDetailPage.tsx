    ...
    <div className="min-h-screen bg-white pb-20 text-slate-900 antialiased [word-break:keep-all] sm:pb-0">
      ...
      <section className="mx-auto max-w-6xl px-5 py-8 sm:px-6 sm:py-10">
        <div className="grid gap-6 lg:grid-cols-2 lg:items-start lg:gap-8">
          ...
          {/* Buy box */}
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-7 lg:sticky lg:top-24">
            ...
            <div className="mt-5 border-t border-slate-100 pt-4">
              ...
              <div className="mt-2 flex flex-wrap gap-1.5">
                {pkg.recommendedFor.map((r) => (
                  <span key={r} className="rounded-lg bg-slate-50 px-2.5 py-1 text-xs font-medium text-slate-600 ring-1 ring-inset ring-slate-200">
                    {r}
                  </span>
                ))}
              </div>
            ...
            <button
              ...
              className="mt-4 flex w-full items-center justify-center rounded-xl bg-slate-900 px-6 py-4 text-base font-bold text-white shadow-sm transition-colors hover:bg-slate-700"
            >
              이 패키지 상담 신청하기
            </button>
            <Link
